...
<body class="bg-gradient-primary">
                        ...
                        <div class="p-5">
                            ...
                            <div id="panel-register-form">
                                <form class="user" action="simpan.php" method="post">
                                    ...
                                    <div class="form-group ">
                                        <select class="form-control form-control-user " style="padding: 1em; height:auto;" aria-label="Default select example" id="input-lomba" name="pilihan">
    ...
    <script>
        $("#button-register-lanjut").on("click", function(e){
            ...
            $("#text-nisn").text($("#input-nisn").val());
            $("#text-sekolah").text($("#input-sekolah").val());
            $("#text-email").text($("#input-email").val());
            $("#text-lomba").text($("#input-lomba").val());
            $("#panel-register-form").hide();
            $("#panel-register-confirm").show();
        });
        $("#button-register-back").on("click", function(e){
            $("#text-nama, #text-nisn, #text-sekolah, #text-email, #text-lomba").text("");
