...
<html lang="en">
    ...
    <body class="bg-flat">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="tampil.php">COMMITTEE PAGE</a>
                    ...
                    <table class="table table-hover" id="table-peserta">
                        ...
                        <tbody>
                            <?php
                                ...
                                if(isset($_GET['cari'])){
                                    $cari = $_GET['cari'];
                                    $sql = "SELECT * FROM formulir WHERE first_name LIKE '%$cari%' OR last_name LIKE '%$cari%' OR asal_sekolah LIKE '%$cari%' OR nisn = '$cari' OR email = '$cari'";
                                }
